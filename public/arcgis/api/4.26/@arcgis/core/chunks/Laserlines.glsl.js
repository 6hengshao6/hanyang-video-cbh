...
vec4 color = vec4(0, 0, 0, 0);`),e.heightManifoldEnabled){t.uniforms.add([new v("angleCutoff",(e=>A(e))),new S("heightPlane",((e,i)=>V(e.heightManifoldTarget,e.renderCoordsHelper.worldUpAtPosition(e.heightManifoldTarget,j),i.camera.viewMatrix)))]);const i=e.spherical?M`normalize(globalOrigin - pos)`:M`heightPlane.xyz`;t.code.add(M`
    {
...
}`)),e.lineVerticalPlaneEnabled&&(t.uniforms.add([new v("angleCutoff",(e=>A(e))),new S("lineVerticalPlane",((e,i)=>function(e,i){const t=m(e.lineVerticalPlaneSegment,.5,j),n=e.renderCoordsHelper.worldUpAtPosition(t,y),o=a(z,e.lineVerticalPlaneSegment.vector),l=c(E,n,o);return a(l,l),V(e.lineVerticalPlaneSegment.origin,l,i.camera.viewMatrix)}(e,i))),new w("lineVerticalStart",((e,i)=>function(e,i){const t=s(j,e.lineVerticalPlaneSegment.origin);return e.renderCoordsHelper.setAltitude(t,0),r(t,t,i.camera.viewMatrix)}(e,i))),new w("lineVerticalEnd",((e,i)=>function(e,i){const t=d(j,e.lineVerticalPlaneSegment.origin,e.lineVerticalPlaneSegment.vector);return e.renderCoordsHelper.setAltitude(t,0),r(t,t,i.camera.viewMatrix)}(e,i)))]),t.code.add(M`{
...
}`)),e.intersectsLineEnabled&&(t.uniforms.add([new v("angleCutoff",(e=>A(e))),new w("intersectsLineStart",((e,i)=>r(j,e.lineStartWorld,i.camera.viewMatrix))),new w("intersectsLineEnd",((e,i)=>r(j,e.lineEndWorld,i.camera.viewMatrix))),new w("intersectsLineDirection",((e,i)=>(s(E,e.intersectsLineSegment.vector),E[3]=0,a(j,f(E,E,i.camera.viewMatrix))))),new b("intersectsLineRadius",(e=>e.intersectsLineRadius))]),t.code.add(M`{
