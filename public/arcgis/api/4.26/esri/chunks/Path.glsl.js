...
f=>f.opacity)]);c.include(D.ColorConversion);A.addMainLightIntensity(c);c.code.add(e.glsl`
      ...
      `);break;case d.ShaderOutput.Depth:case d.ShaderOutput.Shadow:case d.ShaderOutput.ShadowHighlight:case d.ShaderOutput.ShadowExcludeHighlight:b.include(k.Transform,a);q.addNearFar(b);b.varyings.add("depth","float");g.code.add(e.glsl`void main() {
vpos = calculateVPos();
