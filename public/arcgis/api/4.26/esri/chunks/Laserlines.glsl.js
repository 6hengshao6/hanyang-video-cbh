...
}`);return m}function u(e){return F.set(O,Math.cos(e.angleCutoff),Math.cos(Math.max(0,e.angleCutoff-y.deg2rad(2))))}function C(e,m,d){c.transformMat4(D,e,d);c.copy(h,m);h[3]=0;z.transformMat4(h,h,d);return A.fromPositionAndNormal(D,h,P)}const E=y.deg2rad(6),O=w.create(),k=q.create(),h=G.create(),M=q.create(),n=q.create(),D=q.create(),P=A.create(),x=I.create();w=Object.freeze(Object.defineProperty({__proto__:null,build:B,defaultAngleCutoff:E},Symbol.toStringTag,{value:"Module"}));v.LaserlinesShader=
