...
}`);a.uniforms.add(new e.Texture2DPassUniform("blendWeightsTexture",b=>b.blend.colorTexture));a.uniforms.add(new e.Texture2DPassUniform("colorTexture",b=>b.colorTexture));f.addResolutionUniform(a);a.code.add(d.glsl`void main() {
vec4 a;
