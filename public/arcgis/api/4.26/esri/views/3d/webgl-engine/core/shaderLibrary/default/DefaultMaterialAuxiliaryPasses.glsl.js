...
function(v,w,x,y,d,l,m,n,z,p,A,B,C,q,r,t,c,D,u,E){v.DefaultMaterialAuxiliaryPasses=function(b,a){const {vertex:f,fragment:g}=b,k=a.hasModelTransformation;k&&f.uniforms.add(new D.Matrix4PassUniform("model",e=>w.isSome(e.modelTransformation)?e.modelTransformation:x.IDENTITY));const h=a.hasColorTexture&&a.alphaDiscardMode!==E.AlphaDiscardMode.Opaque;switch(a.output){case d.ShaderOutput.Depth:case d.ShaderOutput.Shadow:case d.ShaderOutput.ShadowHighlight:case d.ShaderOutput.ShadowExcludeHighlight:case d.ShaderOutput.ObjectAndLayerIdColor:t.addProjViewLocalOrigin(f,
