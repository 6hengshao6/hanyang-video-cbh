...
cloudsColor *= clamp(fresnelModifier.y * cloudFresnelModifier[0] - cloudFresnelModifier[1], 0.0, 1.0) * clamp((1.0 - totalFadeInOut), 0.0, 1.0);`);b.hasScreenSpaceReflections?(a.uniforms.add([new p.Matrix4PassUniform("view",(e,c)=>c.ssr.camera.viewMatrix),new q.Texture2DPassUniform("lastFrameColorTexture",(e,c)=>c.ssr.lastFrameColorTexture),new f.FloatPassUniform("fadeFactorSSR",(e,c)=>c.ssr.fadeFactor)]),a.code.add(d.glsl`vec3 viewDir = normalize(viewPosition);
